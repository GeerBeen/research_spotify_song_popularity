...
def target_encoding(df, target_col, cat_col):
...
for col in ['popularity', 'danceability', 'energy', 'speechiness', 'acousticness',
...
joblib.dump(best_model_rf, 'models/main_models/random_forest_model.pkl')
